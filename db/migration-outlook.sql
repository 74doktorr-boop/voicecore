...
-- ── Appointments: id del evento en Outlook (para borrar/actualizar) ─────────
ALTER TABLE appointments
  ADD COLUMN IF NOT EXISTS outlook_event_id       TEXT;

COMMENT ON COLUMN appointments.outlook_event_id IS 'Graph event id del evento creado en el Outlook del negocio';
