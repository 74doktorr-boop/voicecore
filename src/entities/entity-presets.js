...
const ENTITY_PRESETS = {
  ...
  taller: {
    ...
    items: [
      ...
      { id: 'tal_ruedas_invierno', label: 'Cambio a ruedas de invierno (otoño)',
        description: 'En zona de frío el cambio estacional es visita fija cada otoño — y aprovechas para revisarle el coche.',
        attrs: { cambio_ruedas_invierno: d(120) } },
      { id: 'tal_aire_verano', label: 'Revisión del A/C antes del verano',
        description: 'Cada primavera todos quieren el aire a tope: carga de gas y filtro, cita asegurada antes del calor.',
        attrs: { revision_aire: d(150) } },
      { id: 'tal_distribucion', label: 'Cambio de distribución (correa)',
        description: 'La avería más cara si se rompe — avisar a tiempo es el trabajo grande que el cliente agradece.',
        attrs: { cambio_distribucion: d(300) } },
    ],
  },
  ...
  veterinaria: {
    ...
    items: [
      ...
      { id: 'vet_rabia', label: 'Refuerzo antirrábica anual',
        description: 'El refuerzo de la rabia es visita obligada cada año — y de paso repasas cartilla y peso.',
        attrs: { refuerzo_rabia: d(365) } },
      { id: 'vet_dental', label: 'Limpieza bucal anual',
        description: 'La limpieza dental evita extracciones caras y programa una visita de alto valor.',
        attrs: { limpieza_dental: d(365) } },
    ],
  },
  ...
  inmobiliaria: {
    ...
    items: [
      ...
      { id: 'inm_alquiler_fin', label: 'Alquiler — fin de contrato',
        description: 'Avisar 2 meses antes del fin del alquiler te da la renovación o el nuevo inquilino sin mes vacío.',
        attrs: { operacion: 'alquiler', fin_contrato_alquiler: d(300) } },
      { id: 'inm_seguro_hogar', label: 'Seguro de hogar — renovación',
        description: 'La renovación del seguro es la excusa perfecta para retomar el contacto con el propietario.',
        attrs: { renovacion_seguro_hogar: d(365) } },
    ],
  },
  ...
  abogados: {
    ...
    items: [
      ...
      { id: 'abo_prescripcion', label: 'Reclamación — prescribe en 1 año',
        description: 'El aviso antes de que prescriba la acción evita perder el derecho y una posible reclamación por responsabilidad.',
        attrs: { fecha_prescripcion: d(330), estado: 'abierto' } },
      { id: 'abo_revision', label: 'Revisión periódica del caso',
        description: 'La revisión programada del expediente mantiene al cliente informado y demuestra un despacho que no lo abandona.',
        attrs: { revision_expediente: d(90), estado: 'en_tramite' } },
    ],
  },
  ...
  asesoria: {
    ...
    items: [
      ...
      { id: 'ase_certificado', label: 'Certificado digital — caduca cada 4 años',
        description: 'Sin certificado no se presenta nada: el aviso a tiempo evita el bloqueo justo en un vencimiento.',
        attrs: { caducidad_certificado_digital: d(1460) } },
      { id: 'ase_cuota_autonomo', label: 'Revisión anual de cuota de autónomos',
        description: 'Revisar la base de cotización cada año es asesoramiento proactivo que fideliza al autónomo.',
        attrs: { revision_cuota_autonomos: d(365) } },
    ],
  },
  ...
  seguros: {
    ...
    items: [
      ...
      { id: 'seg_recibo', label: 'Aviso de próximo recibo',
        description: 'Avisar del recibo antes de que se pase evita el impago y la baja silenciosa de la póliza.',
        attrs: { proximo_recibo: d(60) } },
      { id: 'seg_coberturas', label: 'Revisión de coberturas',
        description: 'El repaso de coberturas es la conversación que sube prima con valor y bloquea al comparador.',
        attrs: { revision_coberturas: d(180) } },
    ],
  },
  ...
  gimnasio: {
    ...
    items: [
      ...
      { id: 'gim_valoracion', label: 'Valoración física trimestral',
        description: 'La valoración periódica mantiene al socio motivado con resultados a la vista — y reduce las bajas.',
        attrs: { plan: 'Con seguimiento', revision_fisica: d(90), estado: 'activa' } },
    ],
  },
  ...
  academia: {
    ...
    items: [
      ...
      { id: 'aca_inicio_curso', label: 'Inicio del próximo curso',
        description: 'Avisar del arranque del curso siguiente reserva plaza antes de que la familia mire otras opciones.',
        attrs: { inicio_curso: d(120) } },
    ],
  },
  ...
  optica: {
    ...
    items: [
      ...
      { id: 'opt_reposicion', label: 'Lentillas — reposición trimestral',
        description: 'Avisar cuando se le acaban las lentillas te asegura la venta recurrente frente a internet.',
        attrs: { tipo_lente: 'lentillas', reposicion_lentillas: d(90) } },
    ],
  },
  ...
  clima: {
    ...
    items: [
      ...
      { id: 'cli_filtros', label: 'Limpieza de filtros semestral',
        description: 'Limpiar filtros dos veces al año da dos visitas fijas y evita la avería que cabrea al cliente.',
        attrs: { limpieza_filtros: d(180) } },
    ],
  },
  ...
  informatica: {
    ...
    items: [
      ...
      { id: 'inf_backup', label: 'Revisión de copias de seguridad',
        description: 'Comprobar los backups cada trimestre es el servicio que evita el desastre — y justifica la cuota.',
        attrs: { revision_backup: d(90) } },
    ],
  },
  ...
  reformas: {
    ...
    items: [
      ...
      { id: 'ref_mantenimiento', label: 'Mantenimiento anual post-reforma',
        description: 'El repaso anual (sellados, juntas) mantiene la reforma como nueva y te trae la siguiente.',
        attrs: { mantenimiento_anual: d(365) } },
    ],
  },
  ...
  agencia_viajes: {
    ...
    items: [
      ...
      { id: 'via_seguro', label: 'Seguro de viaje anual — renovación',
        description: 'El seguro anual renovado a tiempo cubre desde el primer vuelo y abre la venta del siguiente destino.',
        attrs: { renovacion_seguro_viaje: d(300) } },
    ],
  },
  ...
  dental: {
    ...
    items: [
      ...
      { id: 'den_orto_ajuste', label: 'Ortodoncia — ajuste mensual',
        description: 'El ajuste mensual que no se salta acorta el tratamiento y llena el sillón cada mes.',
        attrs: { tipo: 'Ortodoncia', estado: 'en_curso', revision_ortodoncia: d(30) } },
    ],
  },
  ...
  peluqueria: {
    ...
    items: [
      ...
      { id: 'pel_keratina', label: 'Alisado / keratina — renovación',
        description: 'El alisado pierde efecto a los meses: el aviso trae el retoque antes de que la clienta lo note.',
        attrs: { proximo_alisado: d(120) } },
    ],
  },
  ...
  estetica_avanzada: {
    ...
    items: [
      ...
      { id: 'est_mantenimiento', label: 'Sesión de mantenimiento',
        description: 'La sesión de mantenimiento conserva el resultado que tanto costó — y es venta casi asegurada.',
        attrs: { tratamiento: 'Mantenimiento', mantenimiento: d(60) } },
    ],
  },
  ...
  laser: {
    ...
    items: [
      ...
      { id: 'las_mantenimiento', label: 'Mantenimiento anual',
        description: 'Una sesión de mantenimiento al año conserva el resultado impecable — y a la clienta contigo.',
        attrs: { sesion_mantenimiento: d(330) } },
    ],
  },
  ...
  spa: {
    ...
    items: [
      ...
      { id: 'spa_reserva', label: 'Reserva sugerida — no pierdas sesiones',
        description: 'Un empujón amable para reservar la próxima visita mantiene el bono vivo y la agenda llena.',
        attrs: { nombre: 'Circuito spa', sesiones_totales: 3, sesiones_restantes: 2, proxima_reserva: d(30) } },
    ],
  },
  ...
  fisioterapia: {
    ...
    items: [
      ...
      { id: 'fis_revision_alta', label: 'Revisión tras el alta',
        description: 'La revisión un mes después del alta previene la recaída — y demuestra un seguimiento que fideliza.',
        attrs: { motivo: 'Revisión post-alta', revision_alta: d(30) } },
    ],
  },
  ...
  coaching: {
    ...
    items: [
      ...
      { id: 'coa_objetivos', label: 'Revisión de objetivos',
        description: 'Medir el progreso en una fecha fija consolida resultados y abre la conversación del siguiente programa.',
        attrs: { nombre: 'Revisión de objetivos', revision_objetivos: d(45) } },
    ],
  },
  ...
  guarderia_canina: {
    ...
    items: [
      ...
      { id: 'gua_bono_renovar', label: 'Bono de días — renovación',
        description: 'Avisar antes de que se acaben los días de bono mantiene la rutina semanal sin cortes.',
        attrs: { dias_bono_restantes: 2, fin_bono_dias: d(30) } },
    ],
  },
  ...
  residencia_mascotas: {
    ...
    items: [
      ...
      { id: 'res_proxima', label: 'Próxima estancia prevista',
        description: 'Reservar la plaza para las próximas vacaciones con antelación evita el "está completo" de temporada.',
        attrs: { proxima_estancia: d(120) } },
    ],
  },
  ...
  hotel: {
    ...
    items: [
      ...
      { id: 'hot_senal', label: 'Grupo — fecha límite de señal',
        description: 'Avisar de la fecha límite de la señal asegura el cobro y bloquea las habitaciones sin dudas.',
        attrs: { fecha_llegada: d(75), fecha_limite_senal: d(30) } },
    ],
  },
  ...
  clinica: {
    ...
    items: [
      ...
      { id: 'cln_chequeo', label: 'Chequeo anual completo',
        description: 'El chequeo anual programado es la revisión de más valor — y la que el paciente agradece que le recuerdes.',
        attrs: { tipo: 'revision_anual', chequeo_anual: d(365), periodicidad: 'anual' } },
    ],
  },
  ...
  nutricion: {
    ...
    items: [
      ...
      { id: 'nut_control', label: 'Control de peso quincenal',
        description: 'El control frecuente es lo que sostiene la motivación — y el aviso lo hace inevitable.',
        attrs: { proximo_control: d(15), estado: 'activo' } },
    ],
  },
  ...
  pilates: {
    ...
    items: [
      ...
      { id: 'pil_postural', label: 'Revisión postural trimestral',
        description: 'Medir avances cada trimestre mantiene al alumno enganchado a sus resultados.',
        attrs: { revision_postural: d(90) } },
    ],
  },
  ...
  yoga: {
    ...
    items: [
      ...
      { id: 'yog_taller', label: 'Taller / retiro — reserva de plaza',
        description: 'Los talleres y retiros llenan rápido: el aviso con antelación asegura tu plaza (y su ingreso extra).',
        attrs: { proximo_taller: d(45) } },
    ],
  },
  ...
  podologia: {
    ...
    items: [
      ...
      { id: 'pod_recambio_plantillas', label: 'Plantillas — recambio anual',
        description: 'Avisar del recambio antes de que pierdan corrección da una venta programada cada año.',
        attrs: { tipo: 'plantillas', renovacion_plantillas: d(365) } },
    ],
  },
  ...
  psicologia: {
    ...
    items: [
      ...
      { id: 'psi_recordatorio', label: 'Recordatorio de sesión',
        description: 'El recordatorio el día antes reduce las faltas y respeta el proceso — solo administración, cero datos clínicos.',
        attrs: { nombre: 'Sesión programada', proxima_sesion: d(7), modalidad: 'presencial' } },
    ],
  },
  ...
  restaurante: {
    ...
    items: [
      ...
      { id: 'rst_comensales', label: 'Grupo — confirmar comensales',
        description: 'Pedir el número final de comensales unos días antes evita mesas de más y cocina de menos.',
        attrs: { nombre: 'Grupo por confirmar', fecha_limite_comensales: d(14) } },
    ],
  },
  ...
  notaria: {
    ...
    items: [
      ...
      { id: 'not_impuestos', label: 'Herencia — plazo de impuestos',
        description: 'Tras la firma hay plazo para liquidar impuestos: el aviso evita recargos y te posiciona como el que se ocupa de todo.',
        attrs: { tipo: 'herencia', plazo_impuestos: d(60), estado: 'firmado' } },
    ],
  },
  ...
  arquitectura: {
    ...
    items: [
      ...
      { id: 'arq_visita', label: 'Dirección de obra — visita periódica',
        description: 'La visita de obra programada mantiene el proyecto según plano y al cliente tranquilo.',
        attrs: { fase: 'direccion_obra', proxima_visita_obra: d(30) } },
    ],
  },
  ...
  autoescuela: {
    ...
    items: [
      ...
      { id: 'aut_matricula', label: 'Fin de matrícula — renovación',
        description: 'Avisar antes de que caduque la matrícula rescata al alumno dormido antes de que "lo deje".',
        attrs: { estado: 'practicas', fin_matricula_autoescuela: d(180) } },
    ],
  },
  ...
  farmacia: {
    ...
    items: [
      ...
      { id: 'far_receta', label: 'Caducidad de receta crónica',
        description: 'Avisar antes de que caduque la receta evita que el paciente se quede sin su medicación.',
        attrs: { nombre: 'Receta crónica', caducidad_receta: d(90), periodicidad: 'mensual' } },
    ],
  },
  ...
  reconocimientos: {
    ...
    items: [
      ...
      { id: 'rec_recordatorio', label: 'Recordatorio de renovación (con margen)',
        description: 'Un aviso con mes y medio de margen atrapa al que ignoró el primero — cero renovaciones perdidas.',
        attrs: { proxima_renovacion_cert: d(1460) } },
    ],
  },
  ...
  generico: {
    ...
    items: [
      ...
      { id: 'gen_recordatorio', label: 'Segundo aviso / recordatorio',
        description: 'Un empujón final unos días antes atrapa lo que se estaba escapando por olvido.',
        attrs: { nombre: 'Recordatorio', segundo_aviso: d(30) } },
    ],
  },
};
